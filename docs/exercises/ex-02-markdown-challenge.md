...
# Exercise 02 · Markdown Challenge

**Lesson:** 02 — Writing with Markdown | **Difficulty:** Beginner

**Goal:** Format a plain text document using Markdown — no code, just formatting.
...
Your `my-game-plan.md` must use:

- [ ] A `#` heading for the document title
- [ ] `##` headings for each section
- [ ] A bullet point list for features
- [ ] A numbered list for How to Play
- [ ] At least one **bold** word
- [ ] A blockquote `>` for the Note section

---

## Bonus

Add a `##` section called **What I Want to Add Next** with 3 ideas of your own.
...
```bash
git add .
git commit -m "add game plan in markdown"
git push
```
